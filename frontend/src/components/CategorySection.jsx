...
export default function CategorySection() {
  return (
    <section className="py-6 sm:py-16 bg-white">
      {/* Heading */}
      <div className="flex items-center justify-center gap-2 sm:gap-4 mb-3 md:gap-6 sm:mb-12 px-4 sm:px-6">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
          {categories.map((cat) => (
            ...
            >
              {/* Image Card */}
              <div className="relative overflow-hidden rounded-lg h-46 sm:h-60 md:h-70 flex items-center justify-center group-hover:-translate-y-1 group-hover:shadow-2xl transition-all duration-300">
                <img
                  src={cat.image}
                  alt={cat.title}
                  loading="lazy"
              ...
              {/* Title */}
              <div className="mt-4 bg-black/95 w-[100%] m-auto text-center py-2.5 transition-all duration-300 ease-in-out backdrop-blur-sm border border-neutral-800/50 group-hover:bg-black hover:scale-105  hover:shadow-2xl hover:shadow-cyan-500/20 hover:border-cyan-400/60 cursor-pointer active:scale-95 active:rotate-0 active:shadow-xl transform-gpu">
